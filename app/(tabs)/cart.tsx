...
const styles = StyleSheet.create({
  ...
  emptyBody: { fontSize: 14, lineHeight: 21, textAlign: 'center', paddingHorizontal: 8 },
  cta: {
    marginTop: 10,
    borderRadius: 14,
    paddingVertical: 16,
  ...
  confirmBtn: { flex: 1, paddingVertical: 14, borderRadius: 14, alignItems: 'center', borderWidth: 1 },
