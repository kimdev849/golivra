...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 13.5, lineHeight: 20, opacity: 0.85 },
  tabsWrap: {
    flexDirection: 'row',
    marginTop: 16,
    padding: 4,
  ...
  rowAddr: { fontSize: 13, marginTop: 6, lineHeight: 18 },
  stateCard: {
    marginTop: 40,
    borderRadius: 24,
    borderWidth: 1,
  ...
  stateTitle: { fontSize: 16, fontWeight: '800', textAlign: 'center', letterSpacing: -0.2 },
