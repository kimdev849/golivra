...
export function createEnterpriseDetailStyles(c: AppPalette) {
  return StyleSheet.create({
    ...
    block: { paddingHorizontal: 16, paddingTop: 18, gap: 16 },
    ...
    etaHeadRow: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
    etaHeadline: { flex: 1, fontSize: 14, color: c.text, lineHeight: 20, fontWeight: '600' },
    ...
    productDesc: { fontSize: 12, color: c.textMuted, marginTop: 4, lineHeight: 17 },
